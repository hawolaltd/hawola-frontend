...
export const DEFAULT_CONTACT_MERCHANT_DISCLAIMER_HTML = `<p><strong>Disclaimer:</strong> Contact and transactions happen directly between buyer and merchant. Hawola does not verify every listing detail and is not a party to direct deals. Please review our <a href="https://www.hawola.com/terms" target="_blank" rel="noopener noreferrer">Terms of Use</a> before proceeding.</p>`;
