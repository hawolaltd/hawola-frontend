...
import {StateData, StateDataResponse, StateLocationsResponse} from "@/types/general";
...
export const getAllStates = createAsyncThunk("auth/allStates", async (_, thunkAPI) => {
    try {
...
export const getStateLocations = createAsyncThunk("auth/state-location", async (id: string, thunkAPI) => {
    try {
