...
import { verifyLoginCode } from "@/redux/auth/authSlice";
...
export default function LoginByCode() {
  ...
  useEffect(() => {
    ...
    const { code, email, redirect } = router.query;
    ...
    <AuthLayout>
      <div className="flex items-center justify-center min-h-[60vh] px-4">
        <div className="max-w-md w-full text-center">
          <h1 className="text-2xl font-semibold text-[#435a8c] mb-4">
            Signing you in…
          </h1>
          <p className="text-sm text-gray-600 mb-6">
            Please wait while we verify your one-time login link.
          </p>
