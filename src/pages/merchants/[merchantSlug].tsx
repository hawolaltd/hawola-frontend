                            ...
                            <div className="p-4 border-t">
                                ...
                                <div className="mt-4 space-y-2">
                                    <div className="flex items-center">
                                        <svg className="w-5 h-5 merchant-primary-text mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="flex space-x-3">
                                        {merchant.facebook && (
                                            <a href={merchant.facebook} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full merchant-light-bg hover:bg-gray-200 transition">
                                                <svg className="w-5 h-5 merchant-primary-text" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                                                </svg>
                                            </a>
                                        )}
                                        {merchant.twitter && (
                                            <a href={merchant.twitter} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full merchant-light-bg hover:bg-gray-200 transition">
                                                <svg className="w-5 h-5 merchant-primary-text" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        {merchant.instagram && (
                                            <a href={merchant.instagram} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full merchant-light-bg hover:bg-gray-200 transition">
                                                <svg className="w-5 h-5 merchant-primary-text" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        {merchant.tiktok && (
                                            <a href={merchant.tiktok} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full merchant-light-bg hover:bg-gray-200 transition">
                                                <svg className="w-5 h-5 merchant-primary-text" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="mt-6">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-sm font-medium merchant-primary-text">{merchant.merchant_level.name}</span>
                                    </div>
