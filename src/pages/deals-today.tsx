      ...
      <section className="max-w-screen-xl mx-auto px-6 xl:px-0 py-4">
        <div className="rounded-xl overflow-hidden bg-slate-100">
          {heroImage ? (
            ...
            <img src={heroImage} alt="Deals hero banner" className="w-full h-[220px] md:h-[320px] object-cover" />
          ) : null}
          <div className="p-5 md:p-6 bg-white border border-slate-100 border-t-0">
            <h1 className="text-2xl md:text-3xl font-bold text-primary">Deals Today</h1>
            <p className="mt-2 text-sm text-slate-600">
              Curated products marked by admins for today&apos;s deals.
            </p>
            <div className="mt-3">
