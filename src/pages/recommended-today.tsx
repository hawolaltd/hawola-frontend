    ...
    <div>
      ...
      <section className="max-w-screen-xl mx-auto px-6 xl:px-0 py-5 md:py-8">
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          <div className="p-6 md:p-8 bg-gradient-to-r from-indigo-950 via-slate-900 to-cyan-900">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                <p className="text-[11px] uppercase tracking-[0.2em] text-cyan-200">Tailored For You</p>
                <h1 className="mt-2 text-2xl md:text-4xl font-bold text-white">Recommended Today</h1>
              </div>
              <Link
                href="/"
          ...
          {heroImage ? (
            <div className="p-4 md:p-6 pt-5">
              <div className="relative overflow-hidden rounded-xl border border-slate-200">
                ...
                <img src={heroImage} alt="Recommended hero banner" className="w-full h-[190px] md:h-[300px] object-cover" />
              </div>
            </div>
          ) : null}
        </div>
      ...
      <section className="max-w-screen-xl mx-auto px-6 xl:px-0 py-2 pb-20 md:pb-28">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-lg md:text-xl font-semibold text-slate-900">Personal Picks</h2>
