        ...
        <>
            {
                isAuthenticated ?
                    <ul className={`absolute -right-20 ${isAuthenticated ? '-bottom-[17.2rem]' : 'bottom-0'} z-10 mt-2 w-48 bg-white shadow-lg border rounded-md`}>
                        ...
                        <li>
                            <Link href="#"
                                  className="block text-primary px-4 py-2 hover:text-deepOrange">Order
                                Tracking</Link>
                        </li>
                        ...
                        <li>
                            ...
                            <li onClick={() => {
                                ...
                                dispatch(logout())
                                        ...
                                        <span
                                            className="cursor-pointer block text-white bg-deepOrange px-2 py-1 w-full text-center rounded-[4px]">Sign Out</span>
                            </li>

                    </ul>
                    :
                    <ul className={`absolute -right-20 ${isAuthenticated ? '-bottom-[17.2rem]' : '-bottom-[75px]'}  z-10 mt-2 w-48 bg-white shadow-lg border rounded-md`}>

                            <li onClick={() => {
                                router.push('/auth/login')
                            }} className={'px-4 py-2 w-full'}>
                                <button
                                    className="cursor-pointer block text-white bg-deepOrange px-2 py-1 w-full text-center rounded-[4px]">Sign
                                    In
                                </button>
                            </li>
                    </ul>
