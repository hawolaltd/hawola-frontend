...
export default function ResetPasswordForm() {
    ...
    const { control, handleSubmit,  formState: { errors }, } = useForm<ForgotPasswordConfirmFormType>();
    ...
    return (
        <div className="flex  w-full pt-16 mb-28 md:px-28 bg-white">
            <div className="w-full max-w-xl px-8 bg-white ">
                <h2 className="text-4xl font-bold text-[#435a8c]">Reset Password</h2>

                <form onSubmit={handleSubmit(onSubmit)} className={'flex flex-col gap-4 mt-8'}>
                    <ControlledInput<ForgotPasswordConfirmFormType>
                        control={control}
                        errors={errors}
                        name="new_password1"
                        label="Password*"
