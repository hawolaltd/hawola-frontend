...
export default function PremiumMerchantPage() {
  ...
  const primaryColor =
    merchantProfile?.merchant_details?.primary_color || "#88AA17";
  ...
  return (
    <AuthLayout>
      <Head>
        <title>
          {merchantProfile?.merchant_details?.store_name} | Premium Store
        </title>
        <style>{`
      ...
      <section className="py-20 bg-gray-950">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {merchantProfile?.recent_products?.map((product) => (
              <motion.div
                whileHover="hover"
                key={product.id}
