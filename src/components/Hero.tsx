...
const Hero = () => {
    ...
    return (
        ...
        <div className={'xl:col-span-3  rounded-xl'}>
            ...
            <div className={'max-w-screen-xl xl:col-span-3 flex flex-col lg:flex-row gap-6 xl:gap-4 w-full'}>
                <div className={'flex flex-col gap-6 items-center w-full'}>
                    ...
                    <div
                        ...
                        <div className={'flex gap-12 flex-col w-full'}>
                            ...
                            <button className="text-white py-2 bg-[#fe9636] w-2/5 px-4 rounded text-sm">Shop Now
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div
                    className="hidden xl:block w-full xl:w-fit mx-auto p-2 rounded border-2 border-solid border-[#fe9636] gap-2 text-center">
