        ...
        <section className="grid grid-cols-1 lg:grid-cols-6 gap-4 py-4 max-w-screen-xl mx-auto ">
                ...
                <Slider {...settings} className={'rounded-xl col-span-3 bg-[#b8f2ff] bg-custom-bg bg-cover bg-center'}>
                    <div className="w-full p-6">
                        <h1 className="text-5xl font-bold text-gray-800 mb-6 text-left tracking-wide leading-snug">360 Degree <br/> Virtual Reality</h1>
            ...
            <div  className="w-full lg:w-auto mx-auto p-2 rounded border-2 border-solid border-[#fe9636] flex flex-col gap-2 text-center">
                {
