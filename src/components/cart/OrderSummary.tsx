        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <DeleteModal
                ...
                handleDelete={async () => {
                    ...
                    const res = await dispatch(deleteAddress({
                        items: [openDelete]
                    }))
            ...
            <div className="space-y-4">
                ...
                {/* Address Section */}
                {addresses.addresses?.length > 0 ? addresses?.addresses?.map((address: AddressData) => (
                    <AddressCard
                        key={address?.id}
                        address={address}
                ...
                {showForm && (
                    <div className="border-t pt-4 flex flex-col justify-between">
                        <ShippingAddressForm editingAddress={editingAddress} selectedAdd={selectedAdd as AddressData}/>
                        <button
