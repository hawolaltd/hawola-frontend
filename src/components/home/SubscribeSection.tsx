...
const SubscribeSection = () => {
    ...
    return (
        <div className={`max-w-screen-2xl w-full flex items-center justify-center bg-[#0E224D] ${router.pathname.includes('auth') ? 'bg-custom-bg3 bg-center bg-cover bg-no-repeat h-60' : ''} bg-center bg-cover text-white py-10 text-center`}>
